...
class SteamClientProps:
    ...
    send_key_delay_start_scenario : float = 0.01
    send_key_delay_pause_scenario : float = 0.01
    send_key_delay_close_scenario_paused_popup : float = 0.01
    send_key_delay_close_scenario_end_popup : float = 0.5
    send_key_delay_close_player_evaluation_popup : float = 0.5

    check_window_delay_scenario_paused_popup : float = 0.01
    check_window_delay_scenario_end_popup : float = 0.0001
