...
def main():
    ...
    ac_name = yaml_config['agent'].get('ac_name') or yaml_config['agent']['manager_name']
    ...
    agent = MyAgent(
        player_side=player_side,
        manager_name=yaml_config['agent']['manager_name'],
        friendly_names=yaml_config['agent']['friendly_names'],
        target_name=yaml_config['agent']['target_name']
    )
