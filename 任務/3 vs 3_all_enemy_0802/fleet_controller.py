    ...
    def action(self, features):
        ...
        if len(self.agents) > 0:
            ...
            if len(self.fleet_step_history) >= 5:
                ...
                self.agents[0].stats_logger.log_stat("episode_step", step_avg, self.agents[0].total_steps)
                self.agents[0].stats_logger.log_stat("loss", loss_avg, self.agents[0].total_steps)
                self.agents[0].stats_logger.log_stat("episode_return", return_avg, self.agents[0].total_steps)
