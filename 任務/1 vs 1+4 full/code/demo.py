...
def main():
    ...
    parser.add_argument('--player-side', type=str, help='Player side (e.g., T)')
    ...
    # 初始化 Agent
    mgr_name = yaml_config['agent']['ac_name']  # 從已讀取的配置中取得 manager 艦名

    agent = MyAgent(
        player_side=player_side,
        enemy_side='C',
        manager_unit_name=mgr_name     # 傳入 manager 艦名
    )
