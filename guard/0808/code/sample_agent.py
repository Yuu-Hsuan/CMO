...
from scripts.Guard.Mylib import *
import numpy as np
...
class MyAgent(BaseAgent):
    ...
    def __init__(self, player_side, enemy_side=None, manager_unit_name=None):
        ...
        class Args:
            ...
            def __init__(self):
                ...
                self.n_agents = 7             # 只控制 5 艘護航艦
                self.enemy_num = 7            # 敵船 7 艘
                self.n_actions = 13            # 動作空間大小: 7個巡邏任務
    ...
    def apply_action(self, action: int, ac: Unit, features: Multi_Side_FeaturesFromSteam) -> str:
        missions = [
            ...
            'T_PatrolSCS4','T_PatrolSCS5','T_PatrolSCS6','T_PatrolSCS7','T_PatrolSCS8','T_PatrolSCS9','T_PatrolSCS10','T_PatrolSCS11','T_PatrolSCS12','T_PatrolSCS13',
        ]                                   # ⬅︎ 共 7 條   'T_PatrolSCS8','T_PatrolSCS9','T_PatrolSCS10','T_PatrolSCS11','T_PatrolSCS12','T_PatrolSCS13',
