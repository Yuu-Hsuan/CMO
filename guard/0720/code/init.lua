...
local pycmo_path = 'C:/Users/yuhsu/OneDrive/桌面/pycmopen/'
local cmo_path = 'C:/Program Files (x86)/Matrix Games/Command Modern Operations/ImportExport'
local lua_script_foldername = pycmo_path .. 'scripts/new_try/'
...
local execute_agent_action_every_seconds = '4' -- '0' = 1 second, '1' = 5 seconds, '2' = 15 seconds, '3' = 30 seconds, '4' = 1 minute, '5' = 5 minutes, '6' = 15 minutes, '7' = 30 minutes, '8' = 1 hour
local export_observations_every_seconds = '5'
...
ScenEdit_SetEMCON('Side','Taiwan','Radar=Active;Sonar=Active;OECM=Active')
